...
export default function EnquiryManagement() {
  ...
  const [activeEnquiry, setActiveEnquiry] =
    useState<IEnquiryData | null>(null);
      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="mb-6">
          ...
          <p className="mt-1 text-sm text-zinc-400">
            Address, view, and reply to client requests directly
          </p>
        </div>
          ...
          <div className="lg:col-span-1 rounded-xl border border-zinc-800 bg-zinc-900 overflow-hidden h-[75vh] flex flex-col">
            <div className="p-4 border-b border-zinc-800 bg-zinc-900/50">
              <span className="text-xs font-semibold uppercase tracking-wider text-zinc-400">
                Incoming Feed ({enquiries.length})
              </span>
            </div>
                ...
                enquiries.map((enq) => (
                  ...
                  >
                    <div className="flex items-center justify-between gap-2">
                      ...
                      <span
                        className={`text-[9px] px-2 py-0.5 font-bold uppercase rounded-full ${
                          enq.status === "replied"
            ...
            {activeEnquiry ? (
              ...
              <div className="m-auto text-center p-8 text-zinc-500 flex flex-col items-center">
                ...
                <p className="text-xs text-zinc-600 mt-1 max-w-xs">
                  Pick an active conversation block from the
                  timeline feed list to respond.
                </p>
              </div>
            )}
          </div>
