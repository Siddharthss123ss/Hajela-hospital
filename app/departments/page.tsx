                  ...
                  <div className="relative h-52 w-full overflow-hidden bg-slate-200">
                    ...
                    <Image
                      ...
                      className={`
                        ...
                        ${loadedImages[dept._id] ? 'opacity-100 scale-100' : 'opacity-0 scale-105'}
                        group-hover:scale-105
                      `}
                      onLoad={() => handleImageLoad(dept._id)}
                      priority={departments.indexOf(dept) < 4} // 🔴 First 4 images priority
                      quality={80}
                    />
                  ...
                  <div className="flex flex-col flex-1 p-6 pt-9">
                        ...
                        <ul className="space-y-2">
                          {dept.facilities.slice(0, 3).map((facility, idx) => (
                            ...
                            >
                              <CheckCircle2
                                size={14}
                                className="text-cyan-500 mr-2 mt-0.5 flex-shrink-0"
                              />
                              <span>{facility}</span>
                            </li>
                          ))}
                    ...
                    <div className="mt-6 grid grid-cols-2 gap-3">
                      <button
                        onClick={(e) => {
                          e.preventDefault();
                          window.location.href = `tel:+91${dept.contact_number}`;
                        }}
                        className="
                        inline-flex
                        items-center
